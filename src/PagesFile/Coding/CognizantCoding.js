      ...
      <section className="container-fluid bg-light py-5 px-4">
        <div className="container">
          ...
          <div className="trip bg-white p-5 mb-4">
            <p className="text-primary fw-bold mb-2">PLACECOM • COGNIZANT CODING</p>
            <h1 className="fw-bold display-5 mb-2">Cognizant Coding Preparation</h1>
            <p className="text-muted fs-5">
              Most asked coding questions for Cognizant placement preparation
            </p>
          </div>
...
export default CognizantCoding;