      ...
      <section className="container-fluid bg-light py-5 px-4">
        <div className="container">
          ...
          <div className="trip bg-white p-5 mb-4">
            <p className="text-primary fw-bold mb-2">PLACECOM • INFOSYS TECHNICAL</p>
            <h1 className="fw-bold display-5 mb-2">Infosys Technical Preparation</h1>
            <p className="text-muted fs-5">
              Core technical subjects asked in Infosys technical rounds
            </p>
          </div>
          ...
          <div className="trip bg-white p-5 mb-4">
            ...
            <div className="ratio ratio-16x9 rounded overflow-hidden">
              <iframe
                ...
                title="Infosys Technical Preparation"
                frameBorder="0"
                allowFullScreen
              ></iframe>
            </div>
...
export default InfosysTechnical;