      ...
      <section className="container-fluid bg-light py-5 px-4">
        <div className="container">
          ...
          <div className="trip bg-white p-5 mb-4">
            <p className="text-primary fw-bold mb-2">PLACECOM • TCS TECHNICAL</p>
            <h1 className="fw-bold display-5 mb-2">TCS Technical Preparation</h1>
            <p className="text-muted fs-5">
              Core technical subjects asked in TCS technical rounds
            </p>
          </div>
          ...
          <div className="trip bg-white p-5 mb-4">
            ...
            <div className="row g-3">
              ...
              <div className="col-md-6"><div className="bg-light rounded p-3 fw-semibold">Primary Key / Foreign Key</div></div>
          ...
          <div className="trip bg-white p-5 mb-4">
            ...
            <div className="row g-3">
              ...
              <div className="col-md-6"><div className="bg-light rounded p-3 fw-semibold">Semaphore / Mutex</div></div>
            </div>
          </div>
          ...
          <div className="trip bg-white p-5 mb-4">
            ...
            <div className="row g-3">
              ...
              <div className="col-md-6"><div className="bg-light rounded p-3 fw-semibold">HTTP vs HTTPS</div></div>
              <div className="col-md-6"><div className="bg-light rounded p-3 fw-semibold">Routing / Switching</div></div>
            </div>
          </div>
          ...
          <div className="trip bg-white p-5 mb-4">
            ...
            <div className="row g-3">
              ...
              <div className="col-md-6"><div className="bg-light rounded p-3 fw-semibold">Method Overloading</div></div>
              <div className="col-md-6"><div className="bg-light rounded p-3 fw-semibold">Method Overriding</div></div>
            </div>
          </div>
          ...
          <div className="trip bg-white p-5 mb-4">
            ...
            <div className="row g-3">
              ...
              <div className="col-md-6"><div className="bg-light rounded p-3 fw-semibold">DELETE vs DROP vs TRUNCATE</div></div>
          ...
          <div className="trip bg-white p-5 mb-4">
            ...
            <div className="ratio ratio-16x9 rounded overflow-hidden">
              <iframe
                ...
                title="Technical Placement Preparation"
                frameBorder="0"
                allowFullScreen
              ></iframe>
            </div>
