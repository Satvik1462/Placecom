      ...
      <section className="container-fluid bg-light py-5 px-4">
        <div className="container">
          ...
          <div className="trip bg-white p-5 mb-4">
            <p className="text-primary fw-bold mb-2">PLACECOM • WIPRO TECHNICAL</p>
            <h1 className="fw-bold display-5 mb-2">Wipro Technical Preparation</h1>
            <p className="text-muted fs-5">
              Core technical subjects asked in Wipro technical rounds
            </p>
          </div>
          ...
          <div className="trip bg-white p-5 mb-4">
            ...
            <div className="row g-3">
              <div className="col-md-6"><div className="bg-light rounded p-3 fw-semibold">DBMS Basics</div></div>
          ...
          <div className="trip bg-white p-5 mb-4">
            ...
            <div className="ratio ratio-16x9 rounded overflow-hidden">
              <iframe
                src="https://www.youtube.com/embed/ZV0mKQpeX4g"
                title="Wipro Technical Preparation"
                frameBorder="0"
                allowFullScreen
              ></iframe>
            </div>
