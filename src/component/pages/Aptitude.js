        ...
        <div className="row g-4">
          <div className="col-lg-4 col-md-6 col-12">
            <div className="trip bg-white text-center p-4 h-100">
              ...
              <a href="/TCSAptitude">Explore</a>
            </div>
          </div>

          <div className="col-lg-4 col-md-6 col-12">
            <div className="trip bg-white text-center p-4 h-100">
              <img src={Info} alt="Infosys Logo" className="company-logo-img" />
              <h3>Infosys</h3>
              <p className="text-muted">Moderate</p>
              <p className="text-muted">Topics: Quant • Puzzle • Verbal</p>
              <a href="/InfosysAptitude">Explore</a>
            </div>
          </div>

          <div className="col-lg-4 col-md-6 col-12">
            <div className="trip bg-white text-center p-4 h-100">
              <img src={Wipro} alt="Wipro Logo" className="company-logo-img" />
              <h3>Wipro</h3>
              <p className="text-muted">Easy</p>
              <p className="text-muted">Topics: Quant • LR • English</p>
              <a href="/Wipro">Explore</a>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6 col-12">
            <div className="trip bg-white text-center p-4 h-100">
              ...
              <a href="/AccentureAptitude">Explore</a>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6 col-12">
            <div className="trip bg-white text-center p-4 h-100">
              ...
              <a href="/CapgeminiAptitude">Explore</a>
            </div>
          </div>
          ...
          <div className="col-lg-4 col-md-6 col-12">
            <div className="trip bg-white text-center p-4 h-100">
              ...
              <p className="text-muted">Moderate</p>
              <p className="text-muted">Topics: Quant • LR • Verbal</p>
              <a href="/CognizantAptitude">Explore</a>
            </div>
          </div>
        </div>
      </section>
