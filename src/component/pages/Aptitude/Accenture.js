      ...
      <section className="container-fluid py-5 px-4 bg-light">
        <div className="text-center mb-5">
          <h1 className="fw-bold display-5">
            Accenture <span className="text-warning">Preparation</span>{" "}
            <span className="text-primary">Hub</span>
          </h1>

          <p className="text-muted fs-5">
            Complete company-wise preparation for Accenture Aptitude,
        ...
        <div className="trip bg-white p-5 mb-4">
          ...
          <p className="text-muted">
            Accenture aptitude focuses on formulas, speed and logical
            calculations.
          </p>
        ...
        <div className="trip bg-white p-5 mb-4">
          ...
          <p className="text-muted">
            Accenture reasoning focuses on patterns, logic and quick solving.
          </p>
...
export default AccentureAptitude;