      ...
      <section className="container-fluid py-5 px-4 bg-light">
        ...
        <div className="text-center mb-5">
          <h1 className="fw-bold display-5">
            Cognizant <span className="text-warning">Preparation</span>{" "}
            <span className="text-primary">Hub</span>
          </h1>

          <p className="text-muted fs-5">
            Complete preparation for Cognizant Aptitude, Reasoning and Verbal Ability.
          </p>
        </div>
        ...
        <div className="trip bg-white p-5 mb-4">
          ...
          <p className="text-muted">
            Cognizant aptitude focuses on formulas, calculations and time management.
          </p>
        ...
        <div className="trip bg-white p-5 mb-4">
          ...
          <p className="text-muted">
            Cognizant reasoning focuses on analytical thinking and pattern recognition.
          </p>
...
export default CognizantAptitude;